...
var SubscriptionWhere = struct {
	...
	ContentUnitUID: whereHelpernull_String{field: "\"subscriptions\".\"content_unit_uid\""},
	CreatedAt:      whereHelpertime_Time{field: "\"subscriptions\".\"created_at\""},
	UpdatedAt:      whereHelpernull_Time{field: "\"subscriptions\".\"updated_at\""},
}
...
var (
	subscriptionAllColumns            = []string{"id", "user_id", "collection_uid", "content_type", "content_unit_uid", "created_at", "updated_at"}
	subscriptionColumnsWithoutDefault = []string{"user_id"}
	subscriptionColumnsWithDefault    = []string{"id", "collection_uid", "content_type", "content_unit_uid", "created_at", "updated_at"}
...
func (subscriptionL) LoadUser(e boil.Executor, singular bool, maybeSubscription interface{}, mods queries.Applicator) error {
...
func (o *Subscription) SetUser(exec boil.Executor, insert bool, related *User) error {
	var err error
	if insert {
