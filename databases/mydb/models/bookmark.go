...
var BookmarkWhere = struct {
	...
	Name:       whereHelpernull_String{field: "\"bookmark\".\"name\""},
	UserID:     whereHelperint64{field: "\"bookmark\".\"user_id\""},
	SourceUID:  whereHelperstring{field: "\"bookmark\".\"source_uid\""},
	SourceType: whereHelperstring{field: "\"bookmark\".\"source_type\""},
	Data:       whereHelpernull_JSON{field: "\"bookmark\".\"data\""},
	CreatedAt:  whereHelpertime_Time{field: "\"bookmark\".\"created_at\""},
}
...
func FindBookmark(exec boil.Executor, iD int64, selectCols ...string) (*Bookmark, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"bookmark\" where \"id\"=$1", sel,
	)
...
func (o *Bookmark) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"bookmark\"", updateOnConflict, ret, update, conflict, insert)
...
func BookmarkExists(exec boil.Executor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"bookmark\" where \"id\"=$1 limit 1)"
